...
export default function DroneBatteriesPage() {
  return (
    <main className='min-h-screen w-full bg-white'>
      <section className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16'>
        ...
        <div className='mb-12'>
          <h1 className='text-4xl md:text-5xl font-bold text-slate-900'>Drone Batteries</h1>
          <p className='mt-4 text-slate-600 text-lg'>Lightweight, powerful batteries for aerial applications.</p>
        </div>
