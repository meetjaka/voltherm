...
export const Menu = ({
    ...
    return (
        <nav
            ...
            className='shadow-input relative flex items-center justify-between rounded-full border border-transparent bg-white px-8 py-4 dark:border-white/[0.2] dark:bg-black'>
            {children}
        </nav>
    );
};
